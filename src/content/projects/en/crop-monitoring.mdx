...
seo: { title: "Remote Crop Monitoring", description: "IoT system for agriculture with Arduino, JavaScript and Express." }
---
...
- **+312 commits** in the webapp repository
- **9 pull requests** managed
- **License**: GNU GPL v3.0
- **Complete documentation** of quality and design
