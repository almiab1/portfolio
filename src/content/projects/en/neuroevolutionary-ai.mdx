...
seo: { title: "Neuroevolutionary AI for MTG", description: "Development of artificial intelligence using neuroevolution for Magic: The Gathering." }
---
...
- **Java** (66.5%): Main framework
- **Groovy** (30.3%): Automation scripts
