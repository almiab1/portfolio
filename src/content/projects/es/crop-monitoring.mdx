...
- **Lenguajes**: TypeScript (74.2%), HTML (20%), SCSS (5.1%)
...
- **+312 commits** en el repositorio de la webapp
- **9 pull requests** gestionados
- **Licencia**: GNU GPL v3.0
- **Documentación completa** de calidad y diseño
