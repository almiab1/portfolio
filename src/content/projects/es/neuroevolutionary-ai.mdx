...
featured: true
priority: 10
tags: ["AI", "Machine Learning", "Neuroevolution", "MTG"]
tech: ["Python", "Java", "Neuroevolution", "Machine Learning", "Groovy"]
role: "Developer"
links:
  repo: "https://github.com/almiab1/AI_Neuroevolution_MTG"
cover: { src: "/og/neuroevo.png", alt: "IA Neuroevolutiva MTG" }
seo: { title: "IA Neuroevolutiva para MTG", description: "Desarrollo de inteligencia artificial usando neuroevolución para Magic: The Gathering." }
---
...
- **Java** (66.5%): Framework principal
- **Groovy** (30.3%): Scripts de automatización
